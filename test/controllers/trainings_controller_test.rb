...
class TrainingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create training" do
    assert_difference('Training.count') do
      post trainings_url, params: { training: { address: @training.address, bloodtype: @training.bloodtype, name: @training.name } }
    end
  ...
  test "should update training" do
    patch training_url(@training), params: { training: { address: @training.address, bloodtype: @training.bloodtype, name: @training.name } }
